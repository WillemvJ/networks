...
This repo contains example code and assignments for the course. The easiest way to use this is to download the various jupiter notebook (.ipynb) files to your google drive. From there, you will be able to edit them in colab by simply clicking them. You can also share, and work together on the same document. 

You may need to create a google account (in the unlikely case you don't allready have one). 
